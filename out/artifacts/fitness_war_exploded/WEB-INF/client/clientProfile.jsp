            ...
            <div class = "container">
                <div class="rightcolumn" style="width: 100%;">
                    <div class="card">
                        ...
                        <div class="col-75">
                            <input type="text" id="personal_discount" name="personal_discount"  value="${user.personalDiscount}" readonly>
                        </div>
                        ...
                        <div class="col-75">
                            <input type="text" id="corporate_discount" name="corporate_discount"  value="${user.corporateDiscount}" readonly>
                        </div>
