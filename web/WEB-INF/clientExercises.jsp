            ...
            <div class="rightcolumn">
                <c:choose>
                    <c:when test="${is_membership_valid == true}">
                        ...
                        <label for="modal" class="buttonSub" onclick="makeRequest()" style="color: white;text-align: center;margin-top: 10px;padding-top: 15px;width: 80px;height: 30px;font: 14px Tahoma, sans-serif;background: #29c5">Add exercise</label>
