            ...
            <div class="rightcolumn">
                ...
                <c:choose>
                    <c:when test="${is_membership_valid == true}" >
                        <div class="tabs">
                            <input class="tabs__tab" type="radio" id="tabs__tab1" onclick="setArguments('morning',${nutrition.id})" name="tabstab" style="display: none;" checked="checked"/>
                            ...
                            <input class="tabs__tab" type="radio" id="tabs__tab2" onclick="setArguments('lunch',${nutrition.id})" name="tabstab" style="display: none;" checked="checked"/>
                            ...
                            <input class="tabs__tab" type="radio" id="tabs__tab3" onclick="setArguments('dinner',${nutrition.id})" name="tabstab" style="display: none;" checked="checked"/>
